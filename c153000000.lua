...
--Xyz Material is handled by field check automatically
	...
	DeckMasterTableSelect={1231305,153000001,153000002,153000003,153000004,153000005,153000006,153000007,153000008,153000009,153000010,
		153000011,153000012,153000013,153000014,153000015,153000016,153000017}
	DeckMasterTable={1231305,153000001,153000002,153000003,153000004,153000005,153000006,153000007,153000008,153000009,153000010,
